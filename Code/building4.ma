...
initialvalue : 0
initialCellsValue : building4.val
...
[evacuation-rule]
rule : { if (uniform(0,1) < #Macro(saturation), 4, 3) }  0 { (0,0,0) = 0 and (1,0,0) > 1 and (1,0,0) < 10}
rule : { if (uniform(0,1) < #Macro(saturation), 6, 5) }  0 { (0,0,0) = 0 and (0,1,0) > 1 and (0,1,0) < 10}
rule : { if (uniform(0,1) < #Macro(saturation), 8, 7) }  0 { (0,0,0) = 0 and (-1,0,0) > 1 and (-1,0,0) < 10} 
rule : { if (uniform(0,1) < #Macro(saturation), 10, 9) }  0 { (0,0,0) = 0 and (0,-1,0) > 1 and (0,-1,0) < 10}

rule : { if (uniform(0,1) < #Macro(saturation), 4, 3) }  0 { (0,0,0) = 0 and (1,0,0) > 10 and (1,0,0) < 13}
rule : { if (uniform(0,1) < #Macro(saturation), 6, 5) }  0 { (0,0,0) = 0 and (0,1,0) > 10 and (0,1,0) < 13}
rule : { if (uniform(0,1) < #Macro(saturation), 8, 7) }  0 { (0,0,0) = 0 and (-1,0,0) > 10 and (-1,0,0) < 13} 
rule : { if (uniform(0,1) < #Macro(saturation), 10, 9) }  0 { (0,0,0) = 0 and (0,-1,0) > 10 and (0,-1,0) < 13}
